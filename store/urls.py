...
from .views import product_view, show_view, products_page_view, \
    cart_view, cart_add_view, cart_del_view, shop_view, coupon_check_view, \
    delivery_estimate_view, cart_buy_now_view, cart_remove_view
